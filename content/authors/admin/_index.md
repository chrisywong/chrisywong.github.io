...
My current research arc involves different aspects of psHRI with humanoid, mobile, and manipulator robots, particularly by examining a) how a robot can infer intention and react appropriately depending on the context by using a **multimodal analysis** of human posture, gesture, touch, emotional state, physiological signals, environmental signals, etc; b) how [robots can be placed in the retail space](https://chrisywong.github.io/project/retail/) to enhance and assist the shopping experience of those who might have visual or mobility impairments; and c) how [virtrual reality can be used in psHRI](https://chrisywong.github.io/project/vr/). 
